...
public class ConstantPoolTest {
	...
	private float float_num5 = 0f; // N
	private float float_num2 = 1f; // N
	private float float_num3 = 2f; // N
	private float float_num4 = 3f;

	private long long_num5 = 0L; // N
	private long long_num2 = 1L; // N
	private long long_num3 = 2L;
	private long long_num4 = 3L;

	private double double_num5 = 0d; // N
	private double double_num2 = 1d; // N
	private double double_num3 = 2d;
	private double double_num4 = 3d;
